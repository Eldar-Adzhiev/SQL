...
select sum(monthly_salary) as sumSalary
from employees
join employees_salary on employees.id = employees_salary.employee_id 
join roles_employees on roles_employees.employee_id = employees.id
join roles on roles.id = roles_employees.role_id 
...
select min(monthly_salary) as minSalary
from employees
join employees_salary on employees.id = employees_salary.employee_id 
join roles_employees on roles_employees.employee_id = employees.id
join roles on roles.id = roles_employees.role_id 
...
select max(monthly_salary) as maxSalary
from employees
join employees_salary on employees.id = employees_salary.employee_id 
join roles_employees on roles_employees.employee_id = employees.id
join roles on roles.id = roles_employees.role_id 
...
select count(role_name) as count_developer
from employees
join employees_salary on employees.id = employees_salary.employee_id 
join roles_employees on roles_employees.employee_id = employees.id
join roles on roles.id = roles_employees.role_id 
